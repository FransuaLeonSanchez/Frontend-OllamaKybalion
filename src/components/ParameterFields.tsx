...
import { FormData, InputFormat } from "@/types/api";
      ...
      <div className="flex flex-col gap-4 h-full">
        <div className="flex flex-col space-y-2 flex-1 min-h-0">
          ...
          <Textarea
            ...
            onChange={(e) => onFormDataChange({ testText: e.target.value })}
        ...
        <div className="flex flex-col space-y-2 flex-1 min-h-0">
          ...
          <Textarea
            ...
            onChange={(e) => onFormDataChange({ testQuestion: e.target.value })}
            className="flex-1 bg-secondary/50 border-border/50 focus:border-accent transition-colors resize-none"
          />
        </div>
      </div>
    ...
    <div className="flex flex-col gap-4 h-full">
      <div className="flex flex-col space-y-2 flex-1 min-h-0">
        ...
        <Textarea
          ...
          onChange={(e) => onFormDataChange({ questionPrompt: e.target.value })}
          className="flex-1 bg-secondary/50 border-border/50 focus:border-accent transition-colors resize-none"
        />
      </div>
      <div className="flex flex-col space-y-2 flex-1 min-h-0">
        ...
        <Textarea
          ...
          onChange={(e) => onFormDataChange({ questionText: e.target.value })}
          className="flex-1 bg-secondary/50 border-border/50 focus:border-accent transition-colors resize-none"
        />
      </div>
    </div>
